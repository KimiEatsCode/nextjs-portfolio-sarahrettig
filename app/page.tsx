...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-gradient-to-tl from-white via-slate-400/20 to-amber">
      ...
      <h1 className="py-3.5 px-0.5 z-10 text-4xl text-transparent duration-1000 bg-rose-600 cursor-default text-edge-outline font-display sm:text-6xl md:text-9xl whitespace-nowrap bg-clip-text ">
      sarah kimi rettig
      </h1>
